Design a modern, professional footer or hero section titled “AI-Driven Career Excellence — Unlock Your Next Opportunity”. Use clean gradients, crisp typography, and subtle AI/tech-themed accents. Make it inspiring and trustworthy for job seekers and employers alike.
Transform the “Built with Love for Job Seekers” footer section into a professional, high-impact highlight for the Resume Ranker Pro app.

Requirements & Advanced Detailing:

1. Professional Look & Feel
Move away from casual “love” iconography and use a modern, elegant symbol (e.g., trophy, handshake, or glowing shield).
...
2. Rich Content
Short mission statement or vision for job seekers and employers (1–2 lines).

Add a “Backed by AI” or “Powered by Ollama & FAISS” badge with a subtle animated effect.

Key product statistics (users, accuracy, speed, support) with mini animated infographics or counters (e.g., “95%+ Precision”, “10K+ Resumes Analyzed”, “24/7 AI Support”).

Add a row of trust badges: “GDPR Compliant”, “Open Source”, “AI Verified”, etc.
...
Add a sticky “Scroll to Top” button with a smooth animated effect.

Animated avatar or initials for “Parth Chavan”, with a hover card showing GitHub/LinkedIn/contact links.
...
“Built for Job Seekers and Hiring Teams” — dual-sided message for inclusivity.

Add a mini “Powered by AI/ML” explainer popup or link to tech stack details.
...
Consider a “Contact Us” or feedback button, animating in when users linger on the footer.

Keep all core logic and data as in my current code. Focus only on advanced UI, animations, and layout enhancements for this section. Keep styles modern, clean, and elegant — not cartoonish.
...
Add a minimal “What’s New” or “Changelog” modal, animated in via Framer Motion.
